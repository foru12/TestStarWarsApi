...
class ServicePeople:CallBackInterfacePeople {
    private var myCompositeDisposable: CompositeDisposable? = null


    override  fun execute(url: String?, callback: CallBackRequestPeople?) {
                ...
                myCompositeDisposable?.add(
                    it
                        .subscribe({
                            ...
                            Log.e("Error People","!!!" + it.toString())
